...
const AdminSkills = () => {
  // --- SECTION 1: SKILL HERO STATE (Matches skillHeroSchema) ---
  ...
  // --- SECTION 2: INDIVIDUAL SKILL STATE (Skills Table) ---
  ...
  // Handler for Skill Hero (Target: /skill-hero)
  ...
  // Handler for New Skill (Target: /skills)
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "40px auto", padding: "0 20px", fontFamily: "sans-serif" }}>
      ...
      {/* FORM 1: THE HERO (Schema: skillHeroSchema) */}
      <div style={cardStyle}>
